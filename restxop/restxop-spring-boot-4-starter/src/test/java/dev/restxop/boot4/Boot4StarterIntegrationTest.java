...
/**
 * End-to-end starter proof on the Boot 4 generation: auto-configured MVC
 ...
 */
@SpringBootTest(classes = Boot4StarterIntegrationTest.TestApp.class,
...
@Timeout(120)
class Boot4StarterIntegrationTest {
