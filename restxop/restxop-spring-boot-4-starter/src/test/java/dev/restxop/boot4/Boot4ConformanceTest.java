 ...
 * generation's stack (Jackson 3 codec + core engine) — the same suite the
 * Boot 3 starter runs, proving identical wire behavior (SC-005).
 */
class Boot4ConformanceTest extends RestxopConformanceSuite {
